...
<div class="interior-page">
  <div class="interior-layout">
    ...
    <div class="interior-content section-content">
      <h1 class="research-page-title">Teaching</h1>
      <p>I have served as a teaching assistant for both undergraduate and masters-level courses across economics and public policy.</p>

      <div class="resources-list section-list">
        ...
        <div class="resources-entry section-entry">
          <h3>PPOL 533: Impact Evaluation for Development</h3>
          <p class="resources-entry__meta section-entry__meta">Fall 2020</p>
        </div>

        <div class="resources-entry section-entry">
          <h3>PPOL 532: Regression Methods for Development</h3>
          <p class="resources-entry__meta section-entry__meta">Spring 2020</p>
        </div>

        <div class="resources-entry section-entry">
          <h3>PPOL 536: Intermediate Microeconomics for Development</h3>
          <p class="resources-entry__meta section-entry__meta">Fall 2019</p>
        </div>
      </div>
    </div>
  </div>
